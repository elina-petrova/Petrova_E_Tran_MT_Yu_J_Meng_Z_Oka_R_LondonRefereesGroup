...
<body class="cms">
    <section class="create_user_area">
        ...
        <div class="create_user_form">
            <h3>PASSWORD will auto generated by system and send to user.</h3>
            <form action="admin_createuser.php" method="post">
                <!-- <label for="first_name">First Name:</label><br> -->
                <input type="text" name="fname"  id="first_name" placeholder="FIRSTNAME*" value="<?= $user_fname;?>">

                <!-- <label for="last_name">Last Name:</label><br> -->
                <input type="text" name="lname"  id="last_name" placeholder="LASTNAME*" value="<?=$user_lname;?>">


                <!-- <label for="user_name">User Name:</label><br> -->
                <input type="text" name="username"  id="user_name" placeholder="USERNAME*" value="<?= $user_name;?>">

            

                <!-- <label for="email">Email:</label><br> -->
                <input type="email" name="email"  id="email" placeholder="EMAIL*" value="<?= $user_email;?>">
