    ...
    <div class="our-team-hero-content">
             ...
             <div>
                 ...
                 <article class="relativeAboutHeroText">
                   <h1 class="hidden">Team Page Article</h1>
...
<img class="blackImage" src="public/images/members.jpg" alt="Referee Picture">
...
<div class="memberWrap">
<img class="blackImage" src="public/images/members2.jpg" alt="Referee Picture">
<img class="member-colored" src="public/images/members2-clr.jpg" alt="Referee Picture">
<div class="mmbInfo">
<h3>Joe Masse</h3>
<p>Vice	President</p>
</div>
...
<div class="memberWrap">
<img class="blackImage" src="public/images/members3.jpg" alt="Referee Picture">
<img class="member-colored" src="public/images/members3-clr.jpg" alt="Referee Picture">
<div class="mmbInfo">
<h3>John Bray</h3>
<p>Secretary</p>
</div>
...
<p> {{ currentDate }} </p></div>
    ...
    <section class="team-bottom-gallery">
      <h1 class="hidden">Bottom gallery</h1>
  ...
  methods: {
    slideNext: function () {
      ...
      tl.to(".team-gal-overlay", { width: 0, duration: 0.4, delay: 0.05 });
      ...
      setTimeout(this.changeInfo, 800);
